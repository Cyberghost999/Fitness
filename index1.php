...
<body data-spy="scroll" data-target="#navbarNav" data-offset="50">
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container">
            ...
            <a class="navbar-brand" href="index1.php">Gymso Fitness</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-10 mx-auto col-12">
                    <div class="hero-text mt-5 text-center">
                        ...
                        ?>
                            <a href="#feature" class="btn custom-btn mt-3" data-aos="fade-up" data-aos-delay="600">Membership Status</a>
                        <?php
                        }
                        ?>
            ...
            <div class="row">
                ...
                ?>
                    <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                        ...
                        <p data-aos="fade-up" data-aos-delay="200">Our existing members get an extra 7 days extra. <a rel="nofollow" href="RegistrationForm/LoginForm.php">LogIn</a> to claim your free week today.</p>

                        <a href="RegistrationForm/index.php" class="btn custom-btn bg-color mt-3" data-aos="fade-up" data-aos-delay="300" data-toggle="modal">Become a member today</a>
                    </div>
                <?php
                } else {
                ?>
                    <div class="d-flex flex-column justify-content-center ml-lg-auto mr-lg-5 col-lg-5 col-md-6 col-12">
                        <h2 class="mb-3 text-white" data-aos="fade-up">Congratulations!</h2>

                        <h6 class="mb-4 text-white" data-aos="fade-up">Your 2 month free membership period is now active!</h6>

                        <p data-aos="fade-up" data-aos-delay="200">Please contact our nearest branch for further information about you free trial period. Just show them your id and you are good to go!
                        </p>
                    </div>
                <?php
                }
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mt-lg-5 mb-lg-0 mb-4 col-lg-5 col-md-10 mx-auto col-12">
                    ...
                    <p data-aos="fade-up" data-aos-delay="400">And we are here to help you become the best version of yourself.</p>

                    <p data-aos="fade-up" data-aos-delay="500">If you have any question regarding pricing, training schedule or any other services, please feel free to <a rel="nofollow" href="#contact">contact us</a>. Thank you.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="mx-auto mt-4 mt-lg-0 mt-md-0 col-lg-5 col-md-6 col-12">
                    ...
                    <p data-aos="fade-up" data-aos-delay="800"><i class="fa fa-map-marker mr-1"></i> Curves and cuts, Ashoka Enclave 1, Sector-35, Faridabad, Haryana</p>
...
-->
                    <div class="google-map" data-aos="fade-up" data-aos-delay="900">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1086.2642317803259!2d77.31507802913279!3d28.471498607081486!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce76b54026cbd%3A0x1504bc43acd2bea9!2sCurves%20n%20Cuts!5e0!3m2!1sen!2sin!4v1607053096760!5m2!1sen!2sin" width="1920" height="250" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="d-flex justify-content-center mx-auto col-lg-5 col-md-7 col-12">
                    ...
                    <p><i class="fa fa-phone mr-1"></i> 8076715529</p>
